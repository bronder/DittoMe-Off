...
- **Format Detection** - Automatically detects and highlights JSON, XML, HTML, C#, JavaScript, Python, SQL and more
...
- **Search & Filter** - Find content quickly with real-time search highlighting
